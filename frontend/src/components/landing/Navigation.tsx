  ...
  return (
    ...
    >
      ...
      <div className="hidden items-center gap-8 md:flex">
        ...
        <Magnetic pull={0.1}>
          <Link href="#docs" className="text-sm font-medium text-steel transition-none hover:text-safety-orange px-2 py-1">
            Docs
          </Link>
        </Magnetic>
        <Magnetic pull={0.2}>
          <motion.button 
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-pure-white px-4 py-2 text-sm font-semibold text-obsidian transition-colors hover:bg-safety-orange hover:text-pure-white hover:drop-shadow-[0_0_12px_rgba(255,77,0,0.5)]"
          >
            Get Started
          </motion.button>
        </Magnetic>
